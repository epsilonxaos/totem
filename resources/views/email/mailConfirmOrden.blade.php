                                        ...
                                        <td
                                            ...
                                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    role="presentation"
                                                    style="border-bottom:10px solid #202E56;vertical-align:top;"
                                                    width="100%">
                                                    <tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width:98px;">
                                                                                ...
                                                                                <img alt height="auto"
                                                                                    src="{{ Vite::asset('resources/img/app/logo.png') }}"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Inter;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#75B5B0;">
                                                                        Confirmación de compra</div>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">
                                                                        Gracias por tu compra en <span
                                                                            class="text-verde"
                                                                            style="color: #75B5B0; font-weight: 800;">Tótem
                                                                            Beach Club</span>. Estamos emocionados de
                                                                        informarte que tu compra ha sido completada con
                                                                        éxito. A continuación, encontrarás los detalles
                                                                        de tu orden:</div>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="font-size:0px;padding:10px 25px;padding-top:30px;padding-bottom:5px;word-break:break-word;">
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">
                                                                        <span style="font-weight: 600">Fecha de
                                                                            reservación:</span> {{ $fechaReservacion }}
                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <table cellpadding="0"
                                                                                        ...
                                                                                        border="0"
                                                                                        style="color:#000000;font-family:Inter;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                                                                        <tr
                                                                                            style="border-bottom:1px solid #ecedee;text-align:left;padding:15px 0; width: 100%;">
                                                                                            <th
                                                                                        ...
                                                                                        <tr
                                                                                            style="border-bottom:1px solid #ecedee; border-top:1px solid #ecedee;text-align:left;padding:15px 0; width: 100%">
                                                                                            <th
                                                                                                style="padding: 0 15px 0 0;">
                                                                                                Total</th>
                                                                                            <th
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <div
                                                                                            style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">
                                                                                            <span
                                                                                                style="font-weight: 600">Metodo
                                                                                                de pago:</span> Tarjeta
                                                                                        </div>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">
                                                                                        Nos gustaría agradecerte por tu
                                                                                        confianza y apoyo. Si tienes
                                                                                        alguna pregunta sobre tu compra
                                                                                        o necesitas asistencia
                                                                                        adicional, no dudes en contactar
                                                                                        a nuestro equipo de servicio al
                                                                                        cliente a través de
                                                                            ...
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        pasadía! y esperamos atenderte
                                                                                        nuevamente en el futuro.</div>
                                                                                        ...
                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td
                                                                                                                    ...
                                                                                                                    <table
                                                                                                                        ...
                                                                                                                        cellspacing="0"
                                                                                                                        role="presentation"
                                                                                                                        style="background:#202E56;border-radius:3px;width:30px;">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <div
                                                                                                        style="font-family:Inter;font-size:11px;font-weight:500;line-height:16px;text-align:center;color:#445566;">
                                                                                                        &copy; Tótem
                                                                                                        Beach Club.,
                                                                                                        Todos los
                                                                                                        Derechos
