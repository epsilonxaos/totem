...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <![endif]-->
      ...
      <!--[if !mso]><!-->
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;800&display=swap" rel="stylesheet" type="text/css">
        <style type="text/css">
  ...
  <body style="word-spacing:normal;background-color:#F8F8F8;">
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-bottom:10px solid #202E56;vertical-align:top;" width="100%">
        <tbody>
      ...
      <div style="font-family:Inter;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#75B5B0;">Nueva de orden de compra</div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">¡Hola equipo!</div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">Queremos informarles que se ha recibido una nueva orden de compra en nuestro sistema. A continuación, se detallan los datos relevantes:</div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;"><span style="font-weight: 600">Nombre de orden:</span> <span class="text-verde" style="color: #75B5B0; font-weight: 800;">{{$orden}}</span></div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;"><span style="font-weight: 600">Número de folio:</span> <span class="text-verde" style="color: #75B5B0; font-weight: 800;">{{$folio}}</span></div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;"><span style="font-weight: 600">Cliente:</span> {{$cliente}}</div>
      ...
      <div style="font-family:Inter;font-size:14px;font-weight:500;line-height:24px;text-align:left;color:#0E1A3D;">Por favor, asegúrense de revisar esta orden y tomar las medidas necesarias para procesarla de ser necesario de manera oportuna.</div>
     ...
     <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><td><![endif]-->
      ...
      <tr>
        <td style="padding:4px;vertical-align:middle;">
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#202E56;border-radius:3px;width:30px;">
            <tbody>
              <tr>
      ...
      <div style="font-family:Inter;font-size:11px;font-weight:500;line-height:16px;text-align:center;color:#445566;">&copy; Tótem Beach Club., Todos los Derechos Reservados.</div>
