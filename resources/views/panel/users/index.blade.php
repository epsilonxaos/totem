                ...
                @foreach ($user as $item)
                    <tr
                        ...
                        <td class="px-6 py-4 text-center">
							@can([PermissionKey::Admin['permissions']['edit']['name'], PermissionKey::Admin['permissions']['update']['name']])
								<a href="{{route('panel.usuarios.edit', ["id" => $item -> id])}}" class="font-medium text-orange-600 dark:text-orange-500 " title
									='Editar'>
