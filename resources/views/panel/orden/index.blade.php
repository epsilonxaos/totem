                ...
                @foreach ($data as $item)
                    <tr
                        ...
                        <th class="px-6 py-4 text-center flex items-center justify-center">
                            <a title="Ver info"
                                href="{{ route('panel.reservacion.show', ['id' => $item->reservacion_id]) }}"
                                class="text-white bg-sky-700 hover:bg-sky-800 font-medium rounded-lg text-xs px-2 pl-1 py-1 mr-2 flex items-center">
