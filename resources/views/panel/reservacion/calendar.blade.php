        ...
        <div class="flex items-center justify-end pb-4 bg-white dark:bg-gray-900 mb-3">
            @can(PermissionKey::Reservaciones['permissions']['create']['name'])
                <a href="{{ route('panel.reservacion.create') }}"
                    class="px-2 py-1 mr-2 bg-blue-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wide transition ease-in-out duration-150 flex items-center">
