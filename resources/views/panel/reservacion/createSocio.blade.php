            ...
            @can(PermissionKey::Reservaciones['permissions']['create']['name'])
                <form action="{{ route('panel.usuarios.store') }}" method="POST" id="saveReservacion">
                    ...
                    <div class="flex items-center justify-end pb-4 bg-white dark:bg-gray-900">
                        <button type="submit"
                            class="px-2 py-1 bg-slate-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wide transition ease-in-out duration-150 flex items-center">
                    ...
                    <div class="w-full">
                        <div class="w-full flex items-center mb-6">
                            <div class="w-full">
                                <label for="socios" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span
                                        class="text-red-800">*</span> Socios</label>
                                <select id="socios" required
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
                            <div class="col-span-1">
                                <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span
                                    ...
                                    completo</label>
                                <input id="nombre" name="nombre" required disabled autocomplete="off"
                            ...
                            <div class="col-span-1">
                                <label for="fecha_reservacion"
                                    ...
                                    <span class="text-red-800">*</span> Fecha de reservación
                                </label>
                    ...
                    <div class="w-full">
                        <label for="pago_metodo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> <span
                                class="text-red-800">*</span> Método
                            de pago</label>
                        <select id="pago_metodo" disabled
                            ...
                            <option selected value="tarjeta">Tarjeta Débito / Crédito</option>
                    ...
                    <div class="text-center pt-8 mt-16">
                        ...
                        <button type="submit"
                            class="px-2 py-1 mx-auto bg-slate-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wide transition ease-in-out duration-150 flex items-center">
