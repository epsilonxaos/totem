                        ...
                        <div className="mb-4 relative">
                            <MaskedInput
                                ...
                                dispatch={(appended, dynamicMasked) => {
                                    ...
                                    for (
                                        var i = 0;
                                        i < dynamicMasked.compiledMasks.length;
                                        i++
                                    ) {
                                        let re = new RegExp(
